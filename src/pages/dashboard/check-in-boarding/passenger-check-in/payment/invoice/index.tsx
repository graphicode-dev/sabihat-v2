...
function PassengerCheckInPaymentInvoicePage() {
    ...
    const handleSubmit = () => {
        navigate(
            "/check-in-boarding/passenger-check-in/payment/success/baggage"
        );
    };
...
export default PassengerCheckInPaymentInvoicePage;
