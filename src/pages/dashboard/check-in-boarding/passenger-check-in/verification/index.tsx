...
function PassengerCheckInVerificationPage() {
                            ...
                            <div className="space-y-2">
                                {searchResults.map((result) => (
                                    <Link
                                        ...
                                        to={`/check-in-boarding/passenger-check-in/verification/view/${result.id}`}
                                    >
...
export default PassengerCheckInVerificationPage;
