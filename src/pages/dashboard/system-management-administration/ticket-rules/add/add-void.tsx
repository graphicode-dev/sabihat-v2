...
function VoidAddPage() {
    ...
    const [selectedDepartureTolerance, setSelectedDepartureTolerance] = useState<string | null>(null);
    const [selectedPenaltyType, setSelectedPenaltyType] = useState<string | null>(null);
    const [selectedPenaltyValue, setSelectedPenaltyValue] = useState<string | null>(null);
    const [selectedPenaltyBaseAmount, setSelectedPenaltyBaseAmount] = useState<string | null>(null);
    const [selectedTaxRefund, setSelectedTaxRefund] = useState<string | null>(null);

    const { control, handleSubmit, reset, formState } = useForm<Void>({
    ...
    const onSubmit = async (formData: Void) => {
        setIsLoading(true);
        try {
            ...
            addToast({
                message: "Void added successfully",
                type: "success",
                title: "Success!",
            });
            ...
            console.error("Error adding void:", error);
            if (error?.errors) {
