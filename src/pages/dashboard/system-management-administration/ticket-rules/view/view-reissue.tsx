    ...
    return (
        <PageLayout>
            <ViewCard
                ...
                onEdit={() =>
                    navigate(
                        `/system-management-administration/ticket-rules/reissue/edit/${id}`
                    )
                }
                onDelete={() => {
                    addAlertToast(
                        "Are you sure you want to delete this reissue rule?",
                        [
                            {
                                text: "OK",
                                onClick: () => {
                                    addToast({
                                        type: "success",
                                        message: "Reissue rule deleted successfully",
                                        title: "Success!",
                                    });
                                    navigate(-1);
                                },
...
export default ReissueViewPage;
