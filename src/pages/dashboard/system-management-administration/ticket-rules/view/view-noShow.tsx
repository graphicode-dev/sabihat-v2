    ...
    return (
        <PageLayout>
            <ViewCard
                ...
                onEdit={() =>
                    navigate(
                        `/system-management-administration/ticket-rules/no-show/edit/${id}`
                    )
                }
                onDelete={() => {
                    addAlertToast(
                        "Are you sure you want to delete this no-show rule?",
                        [
                            {
                                text: "OK",
                                onClick: () => {
                                    addToast({
                                        type: "success",
                                        message:
                                            "No-show rule deleted successfully",
                                        title: "Success!",
                                    });
                                    navigate(-1);
                                },
