...
function ExcessBaggagePriceB2BVehiclePage() {
    ...
    return (
        <DynamicTable
            ...
            onAddClick={() =>
                navigate(`/sales-bookings/excess-baggage-price-B2B/vehicle/add`)
            }
            onRowClick={(id) =>
                navigate(`/sales-bookings/excess-baggage-price-B2B/vehicle/${id}/view`)
            }
            hideBorder
            noPadding
        />
...
export default ExcessBaggagePriceB2BVehiclePage;
