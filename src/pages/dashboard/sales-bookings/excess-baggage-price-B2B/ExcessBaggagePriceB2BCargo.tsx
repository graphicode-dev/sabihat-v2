...
function ExcessBaggagePriceB2BCargoPage() {
    ...
    return (
        <DynamicTable
            ...
            onAddClick={() =>
                navigate(`/sales-bookings/excess-baggage-price-B2B/cargo/add`)
            }
            onRowClick={(id) =>
                navigate(
                    `/sales-bookings/excess-baggage-price-B2B/cargo/${id}/view`
                )
            }
            hideBorder
            noPadding
...
export default ExcessBaggagePriceB2BCargoPage;
