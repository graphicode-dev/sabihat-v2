...
function ExcessBaggagePriceB2BPassengerPage() {
    ...
    return (
        <DynamicTable
            ...
            columns={columns}
            data={tableData}
            addLabel="Add Excess baggage price B2B"
            onAddClick={() =>
                navigate(`/sales-bookings/excess-baggage-price-B2B/passenger/add`)
            }
            onRowClick={(id) =>
                navigate(
                    `/sales-bookings/excess-baggage-price-B2B/passenger/${id}/view`
                )
            }
            hideBorder
            noPadding
...
export default ExcessBaggagePriceB2BPassengerPage;
