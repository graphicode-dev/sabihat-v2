...
function AllowedWeightPassengerViewPage() {
    ...
    return (
        <PageLayout>
            <ViewCard
                ...
                onCustomButton={() =>
                    navigate(
                        `/sales-bookings/allowed-weight/passenger/${id}/create`
                    )
                }
                onEdit={() =>
                    navigate(
                        `/sales-bookings/allowed-weight/passenger/${id}/edit`
                    )
                }
                onDelete={() => {
                    addAlertToast(
...
export default AllowedWeightPassengerViewPage;
