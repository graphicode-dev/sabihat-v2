...
function AllowedWeightVehiclePage() {
    ...
    return (
        <DynamicTable
            title="All Vehicle Allowed Weight"
            columns={columns}
            data={tableData}
            addLabel="Add Allowed Weight"
            onAddClick={() =>
                navigate(`/sales-bookings/allowed-weight/vehicle/add`)
            }
            onRowClick={(id) =>
                navigate(`/sales-bookings/allowed-weight/vehicle/${id}/view`)
            }
            hideBorder
            noPadding
        />
...
export default AllowedWeightVehiclePage;
