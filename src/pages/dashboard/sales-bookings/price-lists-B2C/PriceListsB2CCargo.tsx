...
function PriceListsB2CCargo() {
    ...
    return (
        <DynamicTable
            title="All Cargo Price List"
            columns={columns}
            data={tableData}
            addLabel="Add Price List"
            onAddClick={() =>
                navigate(`/sales-bookings/price-lists-B2C/cargo/add`)
            }
            onRowClick={(id) =>
                navigate(`/sales-bookings/price-lists-B2C/cargo/${id}/view`)
            }
            hideBorder
            noPadding
        />
...
export default PriceListsB2CCargo;
