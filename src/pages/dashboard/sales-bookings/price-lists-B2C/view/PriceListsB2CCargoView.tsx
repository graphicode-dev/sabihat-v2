...
function PriceListsB2CCargoViewPage() {
    ...
    return (
        <PageLayout>
            <ViewCard
                ...
                onCustomButton={() =>
                    navigate(`/sales-bookings/price-lists-B2C/cargo/${id}/create`)
                }
                onEdit={() =>
                    navigate(`/sales-bookings/price-lists-B2C/cargo/${id}/edit`)
                }
                onDelete={() => {
                    addAlertToast(
...
export default PriceListsB2CCargoViewPage;
