...
function PriceListsB2CPassengerViewPage() {
    ...
    return (
        <PageLayout>
            <ViewCard
                ...
                onCustomButton={() =>
                    navigate(
                        `/sales-bookings/price-lists-B2C/passenger/${id}/create`
                    )
                }
                onEdit={() =>
                    navigate(
                        `/sales-bookings/price-lists-B2C/passenger/${id}/edit`
                    )
                }
                onDelete={() => {
                    addAlertToast(
...
export default PriceListsB2CPassengerViewPage;
