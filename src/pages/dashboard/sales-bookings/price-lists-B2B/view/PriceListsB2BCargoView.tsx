...
function PriceListsB2BCargoViewPage() {
    ...
    return (
        <PageLayout>
            <ViewCard
                ...
                onCustomButton={() =>
                    navigate(`/sales-bookings/price-lists-B2B/cargo/${id}/create`)
                }
                onEdit={() =>
                    navigate(`/sales-bookings/price-lists-B2B/cargo/${id}/edit`)
                }
                onDelete={() => {
                    addAlertToast(
...
export default PriceListsB2BCargoViewPage;
