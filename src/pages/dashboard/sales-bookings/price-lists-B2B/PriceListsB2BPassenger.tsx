...
function PriceListsB2BPassengerPage() {
    ...
    return (
        <DynamicTable
            title="All Passenger Price List"
            columns={columns}
            data={tableData}
            addLabel="Add Price List"
            onAddClick={() =>
                navigate(`/sales-bookings/price-lists-B2B/passenger/add`)
            }
            onRowClick={(id) =>
                navigate(`/sales-bookings/price-lists-B2B/passenger/${id}/view`)
            }
            hideBorder
            noPadding
        />
...
export default PriceListsB2BPassengerPage;
