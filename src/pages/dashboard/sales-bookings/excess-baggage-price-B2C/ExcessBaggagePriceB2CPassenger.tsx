...
function ExcessBaggagePriceB2CPassengerPage() {
    ...
    return (
        <DynamicTable
            title="All Passenger Excess Baggage Price"
            columns={columns}
            data={tableData}
            addLabel="Add Excess Baggage Price"
            onAddClick={() =>
                navigate(`/sales-bookings/excess-baggage-price-B2C/passenger/add`)
            }
            onRowClick={(id) =>
                navigate(`/sales-bookings/excess-baggage-price-B2C/passenger/${id}/view`)
            }
            hideBorder
            noPadding
        />
...
export default ExcessBaggagePriceB2CPassengerPage;
