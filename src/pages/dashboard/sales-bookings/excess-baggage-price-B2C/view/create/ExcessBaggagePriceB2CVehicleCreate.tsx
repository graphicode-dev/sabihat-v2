...
const vehiclePriceListSchema = z.object({
...
function ExcessBaggagePriceB2CVehicleCreatePage() {
    const { addToast } = useToast();
    const [isLoading, setIsLoading] = useState(false);
    const [errors, setErrors] = useState<VehiclePriceList>({
        name: "",
        currency: "",
        passengerType: "",
        ticketType: "",
    ...
    const { control, handleSubmit, reset, formState } =
        useForm<VehiclePriceList>({
            resolver: zodResolver(vehiclePriceListSchema),
            defaultValues: {
                id: "",
                name: "",
                currency: "",
    ...
    const onSubmit = async (formData: VehiclePriceList) => {
        setIsLoading(true);
        try {
            ...
            addToast({
                message: "Vehicle Price List added successfully",
                type: "success",
                title: "Success!",
            });
            ...
            console.error("Error adding Vehicle Price List:", error);
            if (error?.errors) {
...
export default ExcessBaggagePriceB2CVehicleCreatePage;
