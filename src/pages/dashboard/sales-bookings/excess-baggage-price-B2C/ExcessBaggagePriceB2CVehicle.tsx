...
function ExcessBaggagePriceB2CVehiclePage() {
    ...
    return (
        <DynamicTable
            title="All Vehicle Excess Baggage Price"
            columns={columns}
            data={tableData}
            addLabel="Add Excess Baggage Price"
            onAddClick={() =>
                navigate(`/sales-bookings/excess-baggage-price-B2C/vehicle/add`)
            }
            onRowClick={(id) =>
                navigate(
                    `/sales-bookings/excess-baggage-price-B2C/vehicle/${id}/view`
                )
            }
            hideBorder
            noPadding
...
export default ExcessBaggagePriceB2CVehiclePage;
