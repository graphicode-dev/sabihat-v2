            ...
            {isOpen && (
                <div className="absolute right-0 z-10 mt-2 w-32 md:w-80 rounded-md bg-white p-4 shadow-lg ring-1 ring-black ring-opacity-5">
                    ...
                    <div className="mt-4 flex justify-between flex-wrap">
                        <button
                            onClick={addFilter}
                            className="inline-flex items-center gap-1 rounded-md bg-white px-3 py-2 text-sm font-medium text-primary-600 hover:bg-primary-50 border border-primary-200"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className="h-4 w-4"
