...
const cargoCompartmentsSchema = z.object({
...
function CargoCompartmentsEditForm() {
    const { addToast } = useToast();
    const navigate = useNavigate();
    const [isLoading, setIsLoading] = useState(false);
    const [errors, setErrors] = useState<CargoCompartments>({
        cabin: "",
        availableWeight: "",
        availableSize: "",
        availableQuantity: "",
    ...
    const { control, handleSubmit, reset, formState } =
        useForm<CargoCompartments>({
            resolver: zodResolver(cargoCompartmentsSchema),
            defaultValues: {
                id: "",
                cabin: "",
                availableWeight: "",
    ...
    const onSubmit = async (formData: CargoCompartments) => {
        setIsLoading(true);
        try {
            ...
            addToast({
                message: "Cargo Compartments added successfully",
                type: "success",
                title: "Success!",
            });
            ...
            console.error("Error adding cargo compartments:", error);
            if (error?.errors) {
...
export default CargoCompartmentsEditForm;
